...
class PageViewScreenMass extends StatefulWidget {
  const PageViewScreenMass({Key? key}) : super(key: key);

  @override
  State<PageViewScreenMass> createState() => _PageViewScreenMassState();
}

class _PageViewScreenMassState extends State<PageViewScreenMass> {
